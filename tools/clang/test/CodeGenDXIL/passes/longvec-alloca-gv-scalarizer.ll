...
; <label>:51                                      ; preds = %11, %0
  ...
  %stloc1.0 = phi <1 x float> [ %15, %11 ], [ undef, %0 ]
  %stlorc1.0.0 = phi <1 x float> [ %29, %11 ], [ undef, %0 ]
  ...
  %56 = extractelement <1 x float> %stloc1.0, i32 0, !dbg !67
  %57 = extractelement <2 x float> %stloc2.0, i32 1, !dbg !68
  %58 = insertelement <4 x float> undef, float %53, i64 0, !dbg !69
  %59 = insertelement <4 x float> %58, float %55, i64 1, !dbg !69
  %60 = insertelement <4 x float> %59, float %56, i64 2, !dbg !69
  %61 = insertelement <4 x float> %60, float %57, i64 3, !dbg !69
  %62 = getelementptr [3 x [1 x float]], [3 x [1 x float]]* %3, i32 0, i32 %ix, i32 %ix, !dbg !70
  %63 = load float, float* %62, !dbg !70, !tbaa !16
  %64 = getelementptr inbounds [4 x <2 x float>], [4 x <2 x float>]* %dylar2, i32 0, i32 %ix, i32 %ix, !dbg !71
  %65 = load float, float* %64, !dbg !71, !tbaa !16
  %66 = insertelement <4 x float> undef, float %63, i64 0, !dbg !72
  %67 = insertelement <4 x float> %66, float %65, i64 1, !dbg !72
  %68 = insertelement <4 x float> %67, float undef, i64 2, !dbg !72
  %69 = insertelement <4 x float> %68, float undef, i64 3, !dbg !72
  %70 = fadd fast <4 x float> %61, %69, !dbg !73
  %71 = load float, float* getelementptr inbounds ([1 x float], [1 x float]* @dyglob1.v, i32 0, i32 0), align 4, !dbg !74
  %72 = load <2 x float>, <2 x float>* @dyglob2, align 4, !dbg !75
  %73 = extractelement <2 x float> %72, i32 1, !dbg !75
  %load3 = load float, float* @stglob1.0, !dbg !76
  %74 = load <2 x float>, <2 x float>* @stglob2, align 4, !dbg !77
  %75 = extractelement <2 x float> %74, i32 1, !dbg !77
  %76 = insertelement <4 x float> undef, float %71, i64 0, !dbg !78
  %77 = insertelement <4 x float> %76, float %73, i64 1, !dbg !78
  %78 = insertelement <4 x float> %77, float %load3, i64 2, !dbg !78
  %79 = insertelement <4 x float> %78, float %75, i64 3, !dbg !78
  %80 = fadd fast <4 x float> %70, %79, !dbg !79
  %81 = getelementptr [2 x [1 x float]], [2 x [1 x float]]* @dygar1.v, i32 0, i32 %ix, i32 %ix, !dbg !80
  %82 = load float, float* %81, !dbg !80, !tbaa !16
  %83 = getelementptr inbounds [3 x <2 x float>], [3 x <2 x float>]* @dygar2, i32 0, i32 %ix, i32 %ix, !dbg !81
  %84 = load float, float* %83, !dbg !81, !tbaa !16
  %load1 = load float, float* getelementptr inbounds ([2 x float], [2 x float]* @stgar1.0, i32 0, i32 0), !dbg !82
  %85 = load <2 x float>, <2 x float>* getelementptr inbounds ([3 x <2 x float>], [3 x <2 x float>]* @stgar2, i32 0, i32 0), align 4, !dbg !83
  %86 = extractelement <2 x float> %85, i32 1, !dbg !83
  %87 = insertelement <4 x float> undef, float %82, i64 0, !dbg !84
  %88 = insertelement <4 x float> %87, float %84, i64 1, !dbg !84
  %89 = insertelement <4 x float> %88, float %load1, i64 2, !dbg !84
  %90 = insertelement <4 x float> %89, float %86, i64 3, !dbg !84
  %91 = fadd fast <4 x float> %80, %90, !dbg !85
  %92 = extractelement <1 x float> %stlorc1.0.0, i64 0, !dbg !86
  %93 = getelementptr inbounds [1 x float], [1 x float]* %1, i32 0, i32 0, !dbg !87
  %94 = load float, float* %93, align 4, !dbg !87
  %95 = getelementptr inbounds <2 x float>, <2 x float>* %dylorc2.0, i32 0, i32 %ix, !dbg !88
  %96 = load float, float* %95, !dbg !88, !tbaa !16
  %97 = insertelement <4 x float> undef, float %92, i64 0, !dbg !86
  %98 = insertelement <4 x float> %97, float %stlorc2.0.sroa.2.0, i64 1, !dbg !86
  %99 = insertelement <4 x float> %98, float %94, i64 2, !dbg !86
  %100 = insertelement <4 x float> %99, float %96, i64 3, !dbg !86
  %101 = fadd fast <4 x float> %91, %100, !dbg !89
  %load5 = load float, float* @stgrec1.0.0, !dbg !90
  %102 = load float, float* getelementptr inbounds (<2 x float>, <2 x float>* @stgrec2.0, i32 0, i32 1), !dbg !91, !tbaa !16
  %103 = load float, float* getelementptr inbounds ([1 x float], [1 x float]* @dygrec1.0.v, i32 0, i32 0), align 4, !dbg !92
  %104 = getelementptr inbounds <2 x float>, <2 x float>* @dygrec2.0, i32 0, i32 %ix, !dbg !93
  %105 = load float, float* %104, !dbg !93, !tbaa !16
  %106 = insertelement <4 x float> undef, float %load5, i64 0, !dbg !94
  %107 = insertelement <4 x float> %106, float %102, i64 1, !dbg !94
  %108 = insertelement <4 x float> %107, float %103, i64 2, !dbg !94
  %109 = insertelement <4 x float> %108, float %105, i64 3, !dbg !94
  %110 = fadd fast <4 x float> %101, %109, !dbg !95
  %111 = bitcast <2 x float>* %dylorc2.0 to i8*, !dbg !96
  call void @llvm.lifetime.end(i64 8, i8* %111) #0, !dbg !96
  %112 = bitcast [1 x float]* %1 to i8*, !dbg !96
  call void @llvm.lifetime.end(i64 4, i8* %112) #0, !dbg !96
  %113 = bitcast [4 x <2 x float>]* %dylar2 to i8*, !dbg !96
  call void @llvm.lifetime.end(i64 32, i8* %113) #0, !dbg !96
  %114 = bitcast [3 x [1 x float]]* %3 to i8*, !dbg !96
  call void @llvm.lifetime.end(i64 12, i8* %114) #0, !dbg !96
  %115 = bitcast <2 x float>* %dyloc2 to i8*, !dbg !96
  call void @llvm.lifetime.end(i64 8, i8* %115) #0, !dbg !96
  %116 = bitcast [1 x float]* %2 to i8*, !dbg !96
  call void @llvm.lifetime.end(i64 4, i8* %116) #0, !dbg !96
  ret <4 x float> %110, !dbg !97
}
