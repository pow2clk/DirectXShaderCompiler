...
// RUiN: %dxc -DTYPE=bool -DNUM=5     -T vs_6_9 %s | FileCheck %s --check-prefixes=CHECK,I1
// RUiN: %dxc -DTYPE=uint64_t -DNUM=16 -T vs_6_9 %s | FileCheck %s --check-prefixes=CHECK,I64
// RUiN: %dxc -DTYPE=double -DNUM=24   -T vs_6_9 %s | FileCheck %s --check-prefixes=CHECK,F64
...
// CHECK-DAG: %dx.types.ResRet.[[VTY:v[0-9]*[a-z][0-9][0-9]]] = type { [[VTYPE:<[a-z0-9 ]*>]],
// CHECK-DAG: %dx.types.ResRet.[[VTY32:v[0-9]*[a-z][0-9][0-9]]] = type { [[VTYPE]],
// I64: %dx.types.ResRet.[[VTY32:i32]]
// F64: %dx.types.ResRet.[[VTY32:i32]]
// CHECK-DAG: %dx.types.ResRet.[[TY:[if][0-9][0-9]]] = type { [[TYPE:<[a-z0-9]*>]],
// CHECK-DAG: %dx.types.ResRet.[[TY32:[if][0-9][0-9]]] = type { [[TYPE]],
...
void main(uint ix[2] : IX) {
  ...
  // CHECK: call %dx.types.ResRet.[[TY]] @dx.op.rawBufferVectorLoad.[[TY]](i32 139, %dx.types.Handle [[ANHDLRWBY]], i32 [[IX0]]
  // I1: icmp ne i32 %{{.*}}, 0
  ...
  // CHECK: call %dx.types.ResRet.[[TY]] @dx.op.rawBufferVectorLoad.[[TY]](i32 139, %dx.types.Handle [[ANHDLROBY]], i32 [[IX0]]
  // I1: icmp ne i32 %{{.*}}, 0
  ...
  // CHECK: call %dx.types.ResRet.[[TY]] @dx.op.rawBufferVectorLoad.[[TY]](i32 139, %dx.types.Handle [[ANHDLRWST]], i32 [[IX0]]
  // I1: icmp ne i32 %{{.*}}, 0
  vector<TYPE, NUM>  stbElt1 = RwStBuf.Load(ix[0]);
  // CHECK: [[IX1:%.*]] = call i32 @dx.op.loadInput.i32(i32 4,
  // CHECK: call %dx.types.ResRet.[[TY]] @dx.op.rawBufferVectorLoad.[[TY]](i32 139, %dx.types.Handle [[ANHDLRWST]], i32 [[IX1]]
  // I1: icmp ne i32 %{{.*}}, 0
  ...
  // CHECK: call %dx.types.ResRet.[[TY]] @dx.op.rawBufferVectorLoad.[[TY]](i32 139, %dx.types.Handle [[ANHDLROST]], i32 [[IX0]]
  // I1: icmp ne i32 %{{.*}}, 0
  vector<TYPE, NUM>  stbElt3 = RoStBuf.Load(ix[0]);
  // CHECK: call %dx.types.ResRet.[[TY]] @dx.op.rawBufferVectorLoad.[[TY]](i32 139, %dx.types.Handle [[ANHDLROST]], i32 [[IX1]]
  // I1: icmp ne i32 %{{.*}}, 0
  ...
  // CHECK: call %dx.types.ResRet.[[TY]] @dx.op.rawBufferVectorLoad.[[TY]](i32 139, %dx.types.Handle [[ANHDLCON]], i32 [[CONIX]]
  // I1: icmp ne i32 %{{.*}}, 0
