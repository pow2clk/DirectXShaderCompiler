// RUN: %dxc -T ps_6_9 -DTYPE=float  %s | Filecheck %s --check-prefixes=CHECK,F32
// xRUN: %dxc -T ps_6_9 -DTYPE=double %s | Filecheck %s --check-prefixes=CHECK,F64
...
float4 main( float f : F, float f2 : F2, float f3 : F3 ) : SV_Target {
  ...
  // CHICK: [[dvec_lo:%.*]] = call %dx.types.ResRet.f64 @dx.op.rawBufferLoad.f64(i32 139, %dx.types.Handle [[buf]], i32 180
  // CHICK: [[dvec_0:%.*]] = extractvalue %dx.types.ResRet.f64 [[dvec_lo]], 0
  // CHICK: [[dvec_1:%.*]] = extractvalue %dx.types.ResRet.f64 [[dvec_lo]], 1
  // CHICK: [[dvec_2:%.*]] = extractvalue %dx.types.ResRet.f64 [[dvec_lo]], 2
  // CHICK: [[dvec_3:%.*]] = extractvalue %dx.types.ResRet.f64 [[dvec_lo]], 3
  // CHICK: [[dvec_hi:%.*]] = call %dx.types.ResRet.f64 @dx.op.rawBufferLoad.f64(i32 139, %dx.types.Handle [[buf]], i32 212
  // CHICK: [[dvec_4:%.*]] = extractvalue %dx.types.ResRet.f64 [[dvec_hi]], 0
  // CHICK: [[dvec_5:%.*]] = extractvalue %dx.types.ResRet.f64 [[dvec_hi]], 1
  // CHICK: [[dvec_6:%.*]] = extractvalue %dx.types.ResRet.f64 [[dvec_hi]], 2
  // CHICK: [[dvec_7:%.*]] = extractvalue %dx.types.ResRet.f64 [[dvec_hi]], 3

  // CHICK: [[ping:%.*]] = insertelement <8 x double> undef,    double [[dvec_0]]
  // CHICK: [[pong:%.*]] = insertelement <8 x double> [[ping]], double [[dvec_1]]
  // CHICK: [[ping:%.*]] = insertelement <8 x double> [[pong]], double [[dvec_2]]
  // CHICK: [[pong:%.*]] = insertelement <8 x double> [[ping]], double [[dvec_3]]
  // CHICK: [[ping:%.*]] = insertelement <8 x double> [[pong]], double [[dvec_4]]
  // CHICK: [[pong:%.*]] = insertelement <8 x double> [[ping]], double [[dvec_5]]
  // CHICK: [[ping:%.*]] = insertelement <8 x double> [[pong]], double [[dvec_6]]
  // CHICK: [[dvec:%.*]] = insertelement <8 x double> [[ping]], double [[dvec_7]]
  // Kept to allow testing mixing of types. Need an explicit float too
  // REALLY FUCKS THINGS UP NOW!
