...
// RUN: %dxc -DFUNC=acos        -DARITY=1 -T ps_6_9 %s | Filecheck %s --check-prefixes=CHECK,UNARY
// RUN: %dxc -DFUNC=asin        -DARITY=1 -T ps_6_9 %s | Filecheck %s --check-prefixes=CHECK,UNARY
// RUN: %dxc -DFUNC=cos         -DARITY=1 -T ps_6_9 %s | Filecheck %s --check-prefixes=CHECK,UNARY
// RUN: %dxc -DFUNC=cosh        -DARITY=1 -T ps_6_9 %s | Filecheck %s --check-prefixes=CHECK,UNARY
// RUN: %dxc -DFUNC=sin         -DARITY=1 -T ps_6_9 %s | Filecheck %s --check-prefixes=CHECK,UNARY
// RUN: %dxc -DFUNC=sinh        -DARITY=1 -T ps_6_9 %s | Filecheck %s --check-prefixes=CHECK,UNARY
// RUN: %dxc -DFUNC=tan         -DARITY=1 -T ps_6_9 %s | Filecheck %s --check-prefixes=CHECK,UNARY
// RUN: %dxc -DFUNC=abs         -DARITY=1 -T ps_6_9 %s | Filecheck %s --check-prefixes=CHECK,UNARY
// RUN: %dxc -DFUNC=ceil        -DARITY=1 -T ps_6_9 %s | Filecheck %s --check-prefixes=CHECK,UNARY
// RUN: %dxc -DFUNC=exp2        -DARITY=1 -T ps_6_9 %s | Filecheck %s --check-prefixes=CHECK,UNARY
// RUN: %dxc -DFUNC=floor       -DARITY=1 -T ps_6_9 %s | Filecheck %s --check-prefixes=CHECK,UNARY
// RUN: %dxc -DFUNC=frac        -DARITY=1 -T ps_6_9 %s | Filecheck %s --check-prefixes=CHECK,UNARY
// RUN: %dxc -DFUNC=log10       -DARITY=1 -T ps_6_9 %s | Filecheck %s --check-prefixes=CHECK,UNARY
// RUN: %dxc -DFUNC=log2        -DARITY=1 -T ps_6_9 %s | Filecheck %s --check-prefixes=CHECK,UNARY
// RUN: %dxc -DFUNC=mad         -DARITY=3 -T ps_6_9 %s | Filecheck %s --check-prefixes=CHECK,TERTIARY
// RUN: %dxc -DFUNC=pow         -DARITY=2 -T ps_6_9 %s | Filecheck %s --check-prefixes=CHECK,UNARY
// RUN: %dxc -DFUNC=round       -DARITY=1 -T ps_6_9 %s | Filecheck %s --check-prefixes=CHECK,UNARY
// RUN: %dxc -DFUNC=rsqrt       -DARITY=1 -T ps_6_9 %s | Filecheck %s --check-prefixes=CHECK,UNARY
// RUN: %dxc -DFUNC=sqrt        -DARITY=1 -T ps_6_9 %s | Filecheck %s --check-prefixes=CHECK,UNARY
// RUN: %dxc -DFUNC=trunc       -DARITY=1 -T ps_6_9 %s | Filecheck %s --check-prefixes=CHECK,UNARY
...
// RUN: %dxc -DFUNC=saturate    -DARITY=1 -T ps_6_9 %s | Filecheck %s --check-prefixes=CHECK,UNARY
// RUN: %dxc -DFUNC=reversebits -DARITY=1 -DTYPE=uint -T ps_6_9 %s | Filecheck %s --check-prefixes=CHECK,UNARY
